...
data class Information(val companyName: String? = null,val registerNumber: String? = null, val emailAddress: String? = null,
                   val telephoneNumber: String? = null,val businessType: String? = null,val businessAddress: String? = null,val businessCategory: String? = null,  val stringInitImages: List<String>? = null )